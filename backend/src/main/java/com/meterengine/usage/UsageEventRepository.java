...
/**
 * 사용량 이벤트 저장 (MS2-130), 집계 조회 (MS2-129), 로그 조회 (MS2-131).
 *
...
class UsageEventRepository {
   ...
   *
   * <p><b>기간은 반열린 구간 [start, end)다.</b> {@link #sumByCustomer}와 같은 방식으로, 호출자가 KST 월 경계를 계산해 넘긴다. 두
   * API가 같은 달을 다르게 자르면 화면 숫자가 어긋난다.
   *
