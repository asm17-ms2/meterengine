...
public final class ErrorCodes {
  ...
  /**
   * 경로가 가리킨 미터가 없다. 404다 (MS2-157).
   *
   * <p>세 경우가 이 값으로 묶인다. 없는 미터, 다른 도입사 소속, 미등록 도입사. 미터가 도입사에 속하므로(복합 PK) 미등록 도입사의 미터는 존재할 수 없고, 구별해
   * 답하면 남의 도입사에 그 미터가 있다는 사실이 새어 나간다. {@link #CUSTOMER_NOT_FOUND}와 같은 구조다.
   */
