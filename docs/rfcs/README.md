...
1. `template.md`를 복사해 `NNN-하이픈-연결-제목.md`로 만든다. NNN은 아래 표의 다음 세 자리 번호. 번호는 재사용하지 않는다. 아래 표에 draft로 한 줄을 추가한다.
...
| 번호 | 제목 | 도메인 | 상태 | 날짜 |
|---|---|---|---|---|
| [000](000-문서-결정-프로세스.md) | 문서와 결정 프로세스 도입 | process | accepted | 2026-09-02 |
